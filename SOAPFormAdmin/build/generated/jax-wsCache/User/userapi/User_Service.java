 ...
 * 
 */
@WebServiceClient(name = "User", targetNamespace = "http://userAPI/", wsdlLocation = "http://localhost:8084/SOAPForm/User?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USER_QNAME = new QName("http://userAPI/", "User");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/SOAPForm/User?wsdl");
    ...
    public User getUserPort() {
        return super.getPort(new QName("http://userAPI/", "UserPort"), User.class);
    }
    ...
    public User getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://userAPI/", "UserPort"), User.class, features);
    }
